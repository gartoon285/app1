...
export default function Formcheck(){
    ...
    return(
        <div className="mt-4 mx-auto p-3 rounded-1" style={{width:'450px',background:'#cee'}}>
            <form>
                ...
                <div className="text-center mt-4">
                    <button type="button" className="btn btn-sm px-4 btn-primary" onClick={onClickButton}>OK
                    </button>
                </div>
            </form>
        </div>
